...
function SideForm({ sides, handleOnChange }) {
  return (
    <>
      <h1>
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Salsa"
              name="sides"
              checked={sides.includes("Chips & Salsa")}
              onChange={handleOnChange}
            />
            <img
              src={chipssalsa}
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Guac"
              name="sides"
              checked={sides.includes("Chips & Guac")}
              onChange={handleOnChange}
            />
            <img
              src={chipsGuac}
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Queso"
              name="sides"
              checked={sides.includes("Chips & Queso")}
              onChange={handleOnChange}
            />
            <img
              src={chipsQueso}
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Tortilla"
              name="sides"
              checked={sides.includes("Tortilla")}
              onChange={handleOnChange}
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="sides"
              checked={sides.includes("Fountain Drink")}
              onChange={handleOnChange}
            />
            <img
              src={drink}
